...
* [l3xz-hw_can_power_injector](https://github.com/107-systems/l3xz-hw_can_power_injector): Provide power via CAN to all L3X-Z CAN devices.
* [l3xz-hw-pan-tilt-head](https://github.com/107-systems/l3xz-hw-pan-tilt-head): Design files for L3X-Zs pan/tilt colour/thermal camera head.
